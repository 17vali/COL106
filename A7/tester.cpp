...
int main(){
    ...
    string question = "In the interview to News Chronicle, What did gandhi say when asked to sign the request to the PM to settle the dispute between Hindus and Muslims which most likely might have lead to the failure of the round table conference?";
