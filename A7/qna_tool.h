...
public:
    ...
    Sentence(int b_code, int pg, int para) {
        book_code = b_code;
        page = pg;
        paragraph = para;
        count = 0;
...
private:
    ...
    void query_llm_keywords(string filename, string API_KEY, string question);
...
public:
    ...
    Node* c_get_top_k_para(string question, int k, int k1);
};